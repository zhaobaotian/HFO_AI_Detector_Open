function Plot_Final_Label(D_filtered,HFO_Candidates_Raw_BC,HFO_Candidates_highpass,WindowLength,Labels)
...
parfor i = 1:nChannels
    ...
    for j = 1:size(HFO_Candidates_Raw_BC{i},1)
        ...
        title([Channel_Dir '-' num2str(j) '-' ChannelLabel{j} '-' 'Trace'])
        print([Channel_Dir '_' num2str(j) '_' ChannelLabel{j} '_' 'Trace'],'-dpng')
        close
        ...
        title([Channel_Dir '-' num2str(j) '-' ChannelLabel{j} '-' 'TF'])
        print([Channel_Dir '_' num2str(j) '_' ChannelLabel{j} '_' 'TF'],'-dpng')
        close
        ...
        TrainfileName = [Channel_Dir '_' num2str(j) '_' ChannelLabel{j} '_' 'Train'];
