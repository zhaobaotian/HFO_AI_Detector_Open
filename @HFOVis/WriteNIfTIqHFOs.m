function obj = WriteNIfTIqHFOs(obj)

SelectedHFOcountsFinal = obj.HFOCountsQualityHFOs;
...
infoFST1.Description = 'QualityHFOs';
FileName = 'QualityHFOs';

niftiwrite(HFOmaskFinal,FileName,infoFST1)

% obj.BipolarElectrodesMaskHFOs     = HFOmaskFinal;
obj.QualityHFOsFile = [FileName '.nii'];
end
