function obj = WriteNIfTIqFRHFOs(obj)

SelectedHFOcountsFinal = obj.HFOCountsQualityFRHFOs;
...
infoFST1.Description = 'QualityFRHFOs';
FileName = 'QualityFRHFOs';

niftiwrite(HFOmaskFinal,FileName,infoFST1)

% obj.BipolarElectrodesMaskHFOs     = HFOmaskFinal;
obj.QualityFRHFOsFile = [FileName '.nii'];
end
